...
.block1_lower_text p,.widget_wysija_cont .updated, .widget_wysija_cont .login .message  {font-family: <?php echo $font_body; ?>, "Helvetica Neue", Arial, Helvetica, Verdana, sans-serif !important;color:#444;font-size:14px;}
...
.product del, .woocommerce-page ul.product_list_widget li a:hover {color:<?php echo $pmc_data['mainColor']; ?> !important;}
...
.woocommerce #payment #place_order:hover, .woocommerce a.added_to_cart:hover
 ...
 .woocommerce div.product .woocommerce-tabs ul.tabs li.active , .woocommerce div.product .woocommerce-tabs ul.tabs li:hover {background:<?php echo $pmc_data['mainColor']; ?> !important;}
